...
type Configuration struct {
	DebugMode                                      bool
	NumTileX, RealNumTileX, NumTileY, RealNumTileY int
	NumTileForDebug                                int
	TileSize                                       int
...
func setComputedFields() {
	Global.ScreenWidth = Global.RealNumTileX * Global.TileSize * 4
	Global.ScreenHeight = Global.RealNumTileY * Global.TileSize * 4
